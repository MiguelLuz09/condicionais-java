        ...
        do {
            ...
            switch (leia) {
                ...
                case 3:
                    ...
                    char linha = Character.toUpperCase(ler.next().charAt(0));
                ...
                case 4:
                    System.out.println("Digite a Linha desejada [A-L]: ");
                    char linha2 = Character.toUpperCase(ler.next().charAt(0));
                ...
                case 5:
                    System.out.println("Digite a Linha desejada [A-L]: ");
                    char linha3 = Character.toUpperCase(ler.next().charAt(0));
                ...
                case 6:
                    ...
                    System.out.println("Total arrecadado (somente ingressos inteiros efetivamente pagos) " + (c_Ocupado * ingresso));
                    System.out.println("Total em reservas (somente meios ingressos pagos em cadeiras reservadas) " + (c_Reservada * meioIngresso));
                    System.out.println("Receita potencial se todas as reservas forem confirmadas " + ((c_Ocupado * ingresso) + (c_Reservada * ingresso)));
                    System.out.println("Receita potencial máxima se todas as cadeiras livres forem vendidas" + ((c_livre + c_Reservada + c_Ocupado) * ingresso));
                    break;
                ...
                case 7:
                    ...
                    do {
                        ...
                        if (pAtual > 0) System.out.println("A - Página Anterior");
                        if (pAtual < tPaginas - 1) System.out.println("P - Próxima Página");
